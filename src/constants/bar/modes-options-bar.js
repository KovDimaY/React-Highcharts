...
export const tooltips = {
  pureRandom: "In this mode, you have an opportunity to play with different configurations of the bar chart. Use checkboxes to customize the view and press the button to apply changes.",
  ...
  balanceSimulation: "Here you can simulate balance behavior of the home or company bookkeeping. Enter a starting income and spendings, press the \"Start\" button and see how the situation will change during the next 12 months. ",
  symbolsAnalysis: "This mode gives an opportunity to analyze the most frequent characters in the text provided by the user. You can customize the number of the most frequent chars, disable case sensitiveness and even filter chars which you are not interested in.",
  wordsAnalysis: "In this mode, you have an opportunity to analyze the most frequent words in the text provided. You can customize the number of the most frequent words, disable case sensitiveness and even filter words which you are not interested in.",
  interestingFacts: "Here you can see a collection of some interesting facts about different things, represented by bar charts. Use radio buttons to change immediately charts with the info."
}
